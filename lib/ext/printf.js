 ...
 *   - s: converts to a string                                    : Ex 'foo' -> ''
 *   - c: converts to a character                                 : Ex 'foo' -> 'f', 102 -> 'f'
 *   - d: converts to base 10 integer                             : Ex 12 -> '12'
 *   - D: converts to base 10 integer passed through ordinalize() : Ex 12 -> '12th'
 *   - b: converts to base 2 binary                               : Ex 5 -> '101'
 *   - o: converts to base 8 octal                                : Ex 8 -> '10'
 *   - x: converts to base 16 hexidecimal                         : Ex 255 -> 'ff'
 *   - X: converts to uppercase base 16 hexidecimal               : Ex 255 -> 'FF'
 *   - f: converts to a float                                     : Ex 5.99 -> '5.99'
 *
 * @param  {string} str
 * @param  {mixed} ...
 * @return {string}
