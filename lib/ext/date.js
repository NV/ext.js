...
if (Ext.extend) {
  ...
  /**
   * Format date using the given format _str_.
   *
  ...
  Date.prototype.format = function(str) {
    ...
    return str.replace(/%(\w)/, function(_, c){
      switch (c) {
        ...
        case 'd': return self.day < 10 ? '0' + self.day : self.day
        case 'e': return self.day
        case 'P': return self.hours > 11 ? 'pm' : 'am'
        case 'p': return self.hours > 11 ? 'PM' : 'AM'
        case 'S': return self.seconds < 10 ? '0' + self.seconds : self.seconds
      }
    })
  }
}